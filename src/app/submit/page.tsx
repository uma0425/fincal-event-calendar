                  ...
                  {formData.place && (
                    <div className="mt-3">
                      <div className="flex space-x-2">
                        <a
                          href={`https://www.google.com/maps/search/${encodeURIComponent(formData.place)}`}
                          target="_blank"
                        ...
                        <a
                          href={`https://www.openstreetmap.org/search?query=${encodeURIComponent(formData.place)}`}
                          target="_blank"
                          rel="noopener noreferrer"
